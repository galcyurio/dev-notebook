<%@page import="com.sds.commons.BoardPagingManager"%>
...
<%
	BoardPagingManager pm = new BoardPagingManager(request);
	List<Board> boardList = pm.getBoardList();
%>
	...
	<table id="box" align="center" width="603" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td colspan="6" id="list">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<%
						int firstRecord = pm.getFirstRecord();
					%>
					<%for(int i=0; i<boardList.size(); i++){ %>
						...
						<tr align="center" height="20px"
							...
							<td width="50"><%=firstRecord-- %></td>
							<td width="50">
								<img width="40" />
							</td>
							<td width="303"><a href="detail.jsp"><%=board.getTitle() %></a></td>
		...
		<tr>
			<td id="paging" height="20" colspan="6" align="center">
				<a href="/board/list.do?start=<%=pm.getStart()-pm.getPageSize() %>">◀</a>
				<%for(int i=pm.getFirstPage(); i<=pm.getLastPage(); i++){ %>
					<a href="/board/list.do?start=<%=(i - 1)*pm.getPageSize() %>"
					<%if(i == pm.getCurrentPage()) { %> class="pageColoring" <%} %>>
						[<%=i %>]
					</a>
				<%} %>
				<a href="/board/list.do?start=<%=pm.getStart()+pm.getPageSize() %>">▶</a>
		...
		<tr>
			<td height="30" colspan="6" align="right" style="padding-right: 2px;">
				<a href="/board/write.jsp">
					<img src="/board/images/write_btin.gif" width="61" height="20" border="0">
				</a>
			</td>
		</tr>
		<tr>
